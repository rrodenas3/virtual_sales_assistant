...
- Readiness bundles and `/integrations/readiness` now include target-specific runtime validation commands for local, AI-demo, and final pilot handoff from a shared governance helper.
